...
# S3 parameters
attribute :aws_access_key_id, :kind_of => String, :required
attribute :aws_secret_access_key, :kind_of => String, :required
attribute :aws_bucket, :kind_of => String, :required
